...
In addition, \sysname investigates the feasibility of blood glucose monitoring without CGM devices for a longer time (\eg re-calibration every two or three weeks), while previous works only show a possibility of 3 hours~\cite{bib:JDST14:Sobel}.
}
