...
%Stenerson~\etal~\cite{bib:JDST14:Stenerson} integrate acceleration with CGM data to improve the accuracy of blood glucose level estimation.
...
Alternatively, there has been attempt at non-invasive blood glucose monitoring.
