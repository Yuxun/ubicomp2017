...
In addition, \sysname investigates the feasibility of blood glucose monitoring without CGM devices for a longer time (\eg re-calibration per month), while previous works only show the possibility for 3 hours~\cite{bib:JDST14:Sobel}.
}
