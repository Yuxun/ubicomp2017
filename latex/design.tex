...
\begin{itemize}
  ...
  \figref{fig:historical_traces} plots the daily blood glucose traces of a volunteer for five successive days measured by a CGM device. \textcolor[rgb]{1.00,0.00,0.00}{As shown, the blood glucose trances always grow up signifcantly
