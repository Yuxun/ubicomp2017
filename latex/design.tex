...
\end{equation}
$\delta_{abs}$ in \equref{Eq:abs} refers to the impact results of carbohydrate absorption, and $\delta_{egp}$ in \equref{Eq:egp} is the hepatic glucose production from the liver.
...
$\delta_{ind}$ in \equref{Eq:ind} describes results of insulin independent uptake, which is consumed by the central nervous system and the red blood cells.
