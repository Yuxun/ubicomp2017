...
\begin{abstract}
  Inferring abnormal glucose events such as hyperglycemia and hypoglycemia is crucial for the health of both diabetic patients and non-diabetic people.
  However, continuous or regular blood glucose monitoring can be invasive and inconvenient in everyday life.
  \rev{In this paper, we present \sysname, a first smartphone-based blood glucose inference system as a temporary alternative to continuous blood glucose monitors (CGM) when
  ...
  Evaluations on 112 users demonstrate that \modelname yields an average accuracy of 82.14\%, significantly outperforming previous learning methods those are either shallow, generically structured, or oblivious to grouped behaviors. \rev{Also, a user study conducted with the 112 participants shows that \sysname is acceptable for practical usage.}
\end{abstract}
...
\thanks{
Authors address: Weixi Gu, Xi Liu and Lin Zhang, Tsinghua-Berkeley Shenzhen Institute, Shenzhen, China;
E-mails: guweixigavin@gmail.com, liuxi0910@gmail.com, linzhang@tsinghua.edu.cn;
Authors address: Yuxun Zhou, Han Zou and Costas J. Spanos, Electrical Engineering and Computer Sciences, University of California, Berkeley, America;
E-mails: {yxzhou, hanzou, spanos}@berkeley.edu;
