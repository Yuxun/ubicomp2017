...
\begin{abstract}
  Inferring abnormal glucose events such as hyperglycemia and hypoglycemia is crucial for the health of both diabetic patients and non-diabetic people.
  However, continuous or regular blood glucose monitoring can be invasive and inconvenient in everyday life.
  In this paper, we present \sysname, a first smartphone-based blood glucose inference system which reduces a significant part of CGM calibration.
  ...
  Provided with the imbalanced, personalized, and often limited measurements, a challenging part of \sysname is the inference of blood glucose level at a fine-grained time resolution.
