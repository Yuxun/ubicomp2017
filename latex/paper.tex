...
\begin{abstract}
  ...
  Evaluations on 112 users demonstrate that \modelname yields an average accuracy of 82.14\%, significantly outperforming previous learning methods that are either shallow, generically structured, or oblivious to grouped behaviors. \rev{A user study also conducted with these 112 participants shows that \sysname is acceptable for the practical usage.}
\end{abstract}
