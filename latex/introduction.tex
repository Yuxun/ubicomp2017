...
\begin{itemize}
  ...
  \rev{Experimental results from a dataset of 35 non-diabetic people, 38 type I and 39 type II diabetic patients collected for at least 6 days demonstrate that \sysname yields an average accuracy of 82.14\%, and outperforms traditional general learning, group-level learning, personalized learning and shallow/deep learning algorithms in precision and recall.}
\end{itemize}
