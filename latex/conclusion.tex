...
The core of \sysname is a novel learning paradigm, \modelname, which (1) depicts complex glucose dynamics via a deep model, (2) extracts generic feature representations with a grouped multi-task framework, and (3) preserves individual differences using personalized outputs.
