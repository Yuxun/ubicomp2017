...
\fakeparagraph{Typical classifiers without sharing features among users}
...
\begin{itemize}
  ...
  A hidden Markov model (HMM) is a statistical Markov model in which the system being modeled is assumed to be a Markov process with unobserved (hidden) states. It can be presented as the simplest dynamic Bayesian network.
  Simple as it is, HMM has been widely used in signal processing and time series analysis due to its interpretability and tractability.
\end{itemize}

\TODO{results}

\rev{
\fakeparagraph{Typical classifiers that share features from users}
...
We apply multi-task frameworks to share the information among users.
...
\begin{table}[h]
\centering
\caption{Resource cost of training the models}
\label{model_cost}
\begin{tabular}{|c|c|c|c|c|c|c|c|c|c|c|}
\hline
\textbf{Method} & \textbf{RF}               & \textbf{ANN}             & \textbf{GB}              & \textbf{SVM}              & \textbf{GP}               & \textbf{HMM}              & \textbf{mSVM} & \textbf{mGP} & \textbf{nDPHMM} & \textbf{\modelname} \\ \hline
CPU(s)          & \multicolumn{1}{c|}{19.5} & \multicolumn{1}{c|}{8.6} & \multicolumn{1}{c|}{9.5} & \multicolumn{1}{c|}{20.1} & \multicolumn{1}{c|}{26.4} & \multicolumn{1}{c|}{29.5} & 165.8         & 216.2        & 319.1           & 259.9           \\ \hline
RAM(MB)         & 84.2                      & 81.4                     & 84.0                     & 188.4                     & 213.9                     & 112.1                     & 1033.8        & 1428.5       & 1263.0          & 1235.2          \\ \hline
\end{tabular}
\end{table}
