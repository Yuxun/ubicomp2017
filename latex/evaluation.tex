...
To demonstrate the effectiveness of adopting \modelname learning algorithms over the different shallow, deep or multi-task learning algorithms, we compare it with the following  advanced algorithms.
\begin{itemize}
  \item
