...
\figref{fig:pre_gt} compares the predictive results of \sysname and true blood glucose level of three users from non-diabetic group, Type I diabetic group and Type II diabetic group over one day, respectively. And we also use the absolute difference of ground truth level and predicted level to measure the divergence of results, and show them at the bottom figures.
