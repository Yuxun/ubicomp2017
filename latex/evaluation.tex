...
\begin{figure}[h]
  ...
  \caption{An illustration of the equipments for data collection. Each participant wears a CGM device to record blood glucose concentration and uses a smartphone to input external factors. \TODO{do you also have UIs to input drug, meal and insulin intake?}}
...
Overall, \sysname yields an accuracy of 82.14\%, showing the outstanding performance to track blood glucose levels.
...
The blood glucose levels inferred by \sysname also match with the true blood glucose levels most of the time, which validates the effectiveness of \sysname during various daily activities.
...
Moreover, the standard deviations drop gradually from 17.25\% to 10.25\%  of average precision, and from 20.75\% to 10.75\% of average recall.
...
The demonstrate the benefits of sharing data and knowledge among groups and users, we compare \modelname with other learning frameworks with different data sharing schemes.
\begin{itemize}
