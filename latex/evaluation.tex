...
All participants agree to take measurements (\ie wear the CGM device and use \sysname to record external factors) for at least $6$ days, \textcolor[rgb]{1.00,0.00,0.00}{a disposable usage duration of enzyme of the CGM}.
...
\figref{fig:pre_gt} compares the predictive results of \sysname and true blood glucose level of three users from non-diabetic group, Type I diabetic group and Type II diabetic group over one day, respectively. 
...
\begin{figure}[h]
  \centering
  \includegraphics[width=1\columnwidth]{./img/pred_vs_gt1.pdf}
