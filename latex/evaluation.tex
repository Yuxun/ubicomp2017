...
To demonstrate the effectiveness of adopting \modelname learning algorithms over the shallow, deep or multi-task learning algorithms, we compare it with the following  advanced algorithms.
\begin{itemize}
  \item
  ...
  We use the implementation of the fastAdaboost package to combine basic tree classifiers for ensemble learning.
